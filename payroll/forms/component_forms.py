...
class DisbursementBankAccountForm(ModelForm):
    class Meta:
        model = DisbursementBankAccount
        fields = [
            "company_id",
            "bank_name",
            "account_number",
...
# ===========================ICICI Bank Config================================
class ICICIBankConfigForm(ModelForm):
    class Meta:
        model = ICICIBankConfig
        fields = "__all__"
        widgets = {
...
class SalaryDisbursementScheduleForm(ModelForm):
    class Meta:
        model = SalaryDisbursementSchedule
        fields = ["disburse_day", "company_id", "auto_disburse"]
