...
SUBMENUS = [
    ...
    {
        "menu": trans("Salary Disbursement"),
        "redirect": reverse("salary-disbursement-view"),
        "accessibility": "payroll.sidebar.disbursement_accessibility",
    },
]
...
def disbursement_accessibility(request, submenu, user_perms, *args, **kwargs):
    return request.user.has_perm("payroll.view_salarydisbursementschedule")
