...
urlpatterns = [
    ...
    path(
        "salary-disbursement/",
        views.salary_disbursement_view,
        name="salary-disbursement-view",
    ),
    path(
        "disburse-salary/<int:payslip_id>/",
        views.disburse_salary,
        name="disburse-salary",
    ),
    path(
        "disburse-salary-bulk/",
        views.disburse_salary_bulk,
        name="disburse-salary-bulk",
    ),
    path(
        "generate-bank-file/",
        views.generate_bank_file,
        name="generate-bank-file",
    ),
    path(
        "retry-transaction/<int:txn_id>/",
        views.retry_transaction,
        name="retry-transaction",
    ),
    path(
        "create-icici-config",
        views.create_or_update_icici_config,
        name="create-icici-config",
    ),
    path(
        "update-icici-config/<int:config_id>",
        views.create_or_update_icici_config,
        name="update-icici-config",
    ),
    path(
        "create-disbursement-account",
        views.create_or_update_disbursement_account,
        name="create-disbursement-account",
    ),
    path(
        "update-disbursement-account/<int:account_id>",
        views.create_or_update_disbursement_account,
        name="update-disbursement-account",
    ),
    path(
        "delete-disbursement-account/<int:account_id>",
        views.delete_disbursement_account,
        name="delete-disbursement-account",
    ),
    # ===========================Auto salary disbursement settings================================
    path(
        "salary-disbursement-settings-view/",
        views.salary_disbursement_settings_view,
        name="salary-disbursement-settings-view",
    ),
    path(
        "create-salary-disbursement",
        views.create_or_update_salary_disbursement,
        name="create-salary-disbursement",
    ),
    path(
        "update-salary-disbursement/<int:schedule_id>",
        views.create_or_update_salary_disbursement,
        name="update-salary-disbursement",
    ),
    path(
        "delete-salary-disbursement/<int:schedule_id>",
        views.delete_salary_disbursement,
        name="delete-salary-disbursement",
    ),
    path(
        "activate-salary-disbursement",
        views.activate_salary_disbursement,
        name="activate-salary-disbursement",
    ),
]
